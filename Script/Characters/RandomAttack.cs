...
public class RandomAttack : StateMachineBehaviour
{
    ...
    string[] attackTriggers = { "slashattack", "breath", "stern" };
    //string[] attackTriggers = { "slashattack" };
    ...
    void Randomaction(Animator animator)
    {
        System.Random random = new System.Random();
        int randomattack = random.Next(attackTriggers.Length);
